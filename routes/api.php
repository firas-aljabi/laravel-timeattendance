...
Route::group(['middleware' => 'auth:api'], function () {
    ...
    Route::put('reject_justify_request/{id}', [JustifyRquestController::class, 'reject_justify_request']);
    ...
    Route::put('reject_employee_request/{id}', [EmployeeRequestController::class, 'reject_employee_request']);
