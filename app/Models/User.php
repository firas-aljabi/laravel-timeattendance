...
class User extends Authenticatable implements JWTSubject
{
    ...
    protected $fillable = [
        ...
        'birthday_date', 'marital_status', 'address', 'guarantor', 'branch', 'departement', 'gender', 'type', 'status', 'skills',
        'start_job_contract', 'end_job_contract', 'image', 'id_photo', 'biography',
        'employee_sponsorship', 'visa', 'start_visa', 'end_visa',
        'passport', 'start_passport', 'end_passport', 'municipal_card', 'health_insurance',
        'basic_salary', 'company_id', 'permission_to_entry', 'permission_to_leave',
        'code', 'expired_at'
    ];
